...
The course provides a basic hands-on lesson in programming using Python and examples from computational biology. No previous programming knowledge is assumed.
...
3. Paste in the repository URL: `https://github.com/Ishihara-SynthMorph/CompBioHA_IntroProgramming`
4. Select the notebook for the session and click **Open**
5. Save a copy to your own Google Drive (**File > Save a copy in Drive**) so your changes are preserved
